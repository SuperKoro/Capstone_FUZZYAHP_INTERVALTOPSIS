...
A standalone, offline Desktop Application for Supplier Selection using a Hybrid MCDM model (Fuzzy AHP and Interval TOPSIS).

## Features

### Core Functionality
- **Project Management**: Create, open, and save projects as individual .mcdm files
- **Criteria Management**: Add, edit, and delete evaluation criteria with benefit/cost classification
- **Alternative Management**: Manage supplier/alternative options
- **Expert Management**: Support for multiple expert evaluations
